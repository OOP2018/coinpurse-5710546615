...
/**
 * Interface for objects using in withdraw strategy.
 * 
...
public interface WithdrawStrategy {
	 ...
	 * @param money the contents that are available for possible withdraw. Must not be
	 ...
	 *         money parameter (List) whose sum equals the amount. If a solution is
