...
/**
 * User Interface for the Valuable Purse. This class provides simple
 * interactive dialog for inserting and removing money to/from the purse, and
...
public class ConsoleDialog {
	 ...
	 * Show result of success or failure. The user can type the values on same line
	 * as he typed "d", e.g. "d 5 10 1" so check for that.
	 */
	public void depositDialog() {
		...
		if (inline.isEmpty()) {
			System.out.print("Enter value of valuable(s) to deposit on one line [eg: 5 0.5 1]: ");
